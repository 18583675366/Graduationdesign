		...
		<div class="pageFormContent" layouth="56"
			...
			<p>
				<label>课程分类名称：</label> <input name="c_name" type="text" size="30"
					class="textInput required" value="${updatecourseclass.c_name}">
			</p>
			<p>
				<label>课程级别：</label> <select name="c_level" class="required level" data-level="${updatecourseclass.c_level}" >
			...
			<p>
				<label>课程属于那个分类：</label> <select name="c_superior" data-super="${updatecourseclass.c_superior }" class="required super">
					<option value="0" selected="">不属于</option>
				</select>
			</p>
			<p>
				<label>课程分类描述：</label> <input name="c_decs" type="text" size="30"
					class="textInput required" value="${updatecourseclass.c_decs}">
			</p>
		</div>
		<div class="formBar">
			<ul>
